...
#[derive(Debug)]
pub struct CoinbaseSDKProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CoinbaseSDKProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CoinbaseSDK processing");
    
    let mut processor = CoinbaseSDKProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CoinbaseSDKProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CoinbaseSDKProcessor::new(false);
